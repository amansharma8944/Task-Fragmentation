...
import BurnInfoBox from './components/BurnInfoBox'; // Adjust paths as necessary
    ...
    return (
        <BurnPageContainer>
            <DashboardLayoutStyled className="burnpage">
                <div className="top_container burnpage" style={{ alignItems: "flex-start" }}>
                    <BurnInfoBox
            ...
            <TransactionTableStyled>
                <TransactionList  data={burnTransactions}
